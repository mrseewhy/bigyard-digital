...
const SECTION_LABEL =
  "font-body text-xs font-semibold tracking-widest uppercase text-text-muted dark:text-dark-text-muted mb-3 block";
const BODY_TEXT =
  "font-body text-base leading-relaxed text-text-secondary dark:text-dark-text-secondary";
