...
const SERVICES = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        body: "Custom-built web platforms designed for performance, clarity, and trust. Not templates. Not shortcuts. A system that works as hard as your business does.",
      },
    ],
    deliverables: [
  ...
  },
  {
    ...
    details: [
      ...
      {
        heading: "What we deliver",
        body: "Automation systems that integrate with your existing tools and workflows. Not random automations. Structured systems that actually improve how your business runs.",
      },
    ],
    deliverables: [
...
"
      ...
      {SERVICES.map(
        ({ id, number, tag, title, summary, details, deliverables }, index) => (
          <section
            key={id}
            id={id}
            className={`w-full ${
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-24">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                {/* Right — Deliverables */}
                <div
                  className={`p-8 rounded-2xl border border-border dark:border-dark-border ${
                    index % 2 === 0
                      ? "bg-surface-2 dark:bg-dark-base"
                      : "bg-surface dark:bg-dark-2"
                  }`}
