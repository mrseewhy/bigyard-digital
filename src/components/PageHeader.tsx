  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-14">
        ...
        {/* Title */}
        <h1 className="font-display font-bold tracking-tight leading-tight text-text-primary dark:text-dark-text-primary max-w-4xl text-[clamp(32px,5vw,50px)]">
          {title}
        </h1>

        {/* Optional subtitle */}
        {subtitle && (
          <p className="font-body text-lg leading-relaxed text-text-secondary dark:text-dark-text-secondary max-w-3xl mt-5">
            {subtitle}
          </p>
        )}
      </div>
