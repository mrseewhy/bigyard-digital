...
const TRUST_SIGNALS = [
  {
    label: "A focused strategy call",
    detail:
      "30 minutes. No pitch. Just an honest conversation about your project and what it needs.",
  },
  {
    label: "Clear direction on what to build",
    detail:
      "If we're a fit, you'll receive a scoped proposal with timeline and investment within 48 hours.",
  },
  {
    label: "Honest feedback (even if we’re not the right fit)",
    detail:
      "Scope, timeline, and price are agreed upfront. We don't move goalposts once a project starts.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="font-body text-base leading-relaxed text-text-secondary dark:text-dark-text-muted mb-10 max-w-md">
              We only take on a limited number of projects each quarter. If
              you’re serious about growth, this is where the conversation
              starts.
            </p>
