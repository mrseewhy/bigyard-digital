...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    name: "Anthonia Akingbade",
    title: "Dir, Customer Success, Microware Solutions",
    imgUrl: "img/test/tope.jpg",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          ...
          <p className="font-body text-base leading-relaxed text-text-muted dark:text-dark-text-muted max-w-sm">
            Every project we deliver is a relationship we intend to keep. Here's
            what some of those clients have to say.
          </p>
        </div>

        {/* ── Testimonial Cards ── */}
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map(({ quote, name, title, imgUrl }, index) => (
            <div
              key={index}
